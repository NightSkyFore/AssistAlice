...
def g2p(text, tokenizer, impl='v2'):
    ...
    phones, tones, word2ph = _func(sentences, tokenizer)
    ...
    for seg in segments:
        ...
        for c, v in zip(initials, finals):
            if c == 'EN_WORD':
                ...
                phones_en, tones_en, word2ph_en = g2p_en(None, None, tokenized_en, False)
...
def _g2p_v2(segments, tokenizer):
    spliter = '#$&^!@'
    ...
    for text in segments:
        ...
        for text in texts:
            if re.match('[a-zA-Z\s]+', text):
                ...
                phones_zh, tones_zh, word2ph_zh = _g2p([text])
